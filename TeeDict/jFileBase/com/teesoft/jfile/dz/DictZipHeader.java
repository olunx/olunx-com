...
public class DictZipHeader {
    ...
    public static DictZipHeader readHeader(String s) throws IOException {
        ...
        InputStream in = FileFactory.openFileAccess(s,true).getInputStream();
    ...
    int getChunckBySrcOffset(long srcOffset) {

        for(int i=0;i<offsets.length-1;i++)

            if(offsets[i] > srcOffset)
    ...
    int getChunckByDstOffset(long l) {

        return (int)(l / this.chunkLength);
