...
public class XMLReader {
	 ...
	 *             If there was a problem while reading the content (malformed
	 ...
	 */
	public Document readFile(File f) throws FileNotFoundException, JDOMException, IOException {
	...
	private void checkReceivedFileObject(File f) throws FileNotFoundException {
		...
		if (!f.exists()) {
			throw new FileNotFoundException("The file does not exist: " + f.getAbsolutePath());
		}
		if (!f.isFile()) {
			throw new IllegalArgumentException("The file: " + f.getAbsolutePath() + " is not a file! (folder?)");
		}
	}
	 ...
	 * @return The read document
	 * @throws JDOMException
	 *             If the InputStream does not contain a valid document
	 * @throws IOException
	 *             If there was a problem while reading the document
	 * @throws IllegalArgumentException
	 ...
	 * @throws JDOMException
	 *             If there is a problem with the xml in the file (invalid
	 *             document)
	 * @throws IOException
	 *             If there was a problem while reading the file
	 * @throws IllegalArgumentException
	 ...
	 */
	public String readFileAsString(File f) throws FileNotFoundException, JDOMException, IOException {
		checkReceivedFileObject(f);
