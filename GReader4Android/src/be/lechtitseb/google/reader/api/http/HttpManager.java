...
public interface HttpManager {
	 ...
	 * @throws GoogleReaderException
	 */
	byte[] download(String url, List<Parameter> parameters) throws GoogleReaderException;
	 ...
	 * @throws GoogleReaderException
	 */
	byte[] download(String url, List<Parameter> parameters, boolean useCookies) throws GoogleReaderException;
	 ...
	 * @throws GoogleReaderException
	 */
	String get(String url, List<Parameter> parameters) throws GoogleReaderException;
	 ...
	 * @throws GoogleReaderException
	 */
	String get(String url, List<Parameter> parameters, boolean useCookies) throws GoogleReaderException;
	 ...
	 * @throws GoogleReaderException
	 */
	String post(String url, List<Parameter> parameters) throws GoogleReaderException;
	 ...
	 * @throws GoogleReaderException
	 */
	String post(String url, List<Parameter> parameters, boolean useCookies) throws GoogleReaderException;
