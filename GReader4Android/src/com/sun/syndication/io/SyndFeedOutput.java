...
public class SyndFeedOutput {
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create XML representation from. The type of
	 ...
	 *             thrown if the XML representation for the feed could not be
	 *             created.
	 * 
	 */
	 ...
	 *            constructor.
	 * @param file
	 *            the file where to write the XML representation for the given
	 *            SyndFeedImpl.
	 * @throws IOException
	 ...
	 *            constructor.
	 * @param writer
	 *            Writer to write the XML representation for the given
	 *            SyndFeedImpl.
	 * @throws IOException
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create W3C DOM document from. The type of the
	 *            SyndFeedImpl must match the type given to the FeedOuptut
	 *            constructor.
	 * @return the W3C DOM document for the given SyndFeedImpl.
	 * @throws FeedException
	 *             thrown if the W3C DOM document for the feed could not be
	 *             created.
	 * 
	 */
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create JDOM document from. The type of the
	 *            SyndFeedImpl must match the type given to the FeedOuptut
	 *            constructor.
	 * @return the JDOM document for the given SyndFeedImpl.
	 * @throws FeedException
	 *             thrown if the JDOM document for the feed could not be
	 *             created.
	 * 
	 */
