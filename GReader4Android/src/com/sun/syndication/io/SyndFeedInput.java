...
public class SyndFeedInput {
	 ...
	 * 
	 * @param validate
	 *            indicates if the input should be validated. NOT IMPLEMENTED
	 *            YET (validation does not happen)
	 * 
	 */
	 ...
	 * 
	 * @param heals
	 *            TRUE enables stream healing, FALSE disables it.
	 * 
	 */
	 ...
	 *            set to true to make the WireFeed is made available in the
	 *            SyndFeed. False by default.
	 */
