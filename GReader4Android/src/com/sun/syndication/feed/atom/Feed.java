...
public class Feed extends WireFeed {
	 ...
	 *            the list of Link elements with the feed alternate links to
	 ...
	 * 
	 * @param otherLinks
	 *            the list of Link elements with the feed other links
	 ...
	 * 
	 * @param tagline
	 *            the feed tagline to set, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param id
	 *            the feed ID to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param generator
	 *            the feed generator to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param info
	 *            the feed info to set, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param modified
	 *            the feed modified date to set, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param entries
	 *            the list of Entry elements with the feed entries to set, an
