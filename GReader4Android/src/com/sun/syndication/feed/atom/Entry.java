...
public class Entry implements Cloneable, Serializable, Extendable {
	 ...
	 * 
	 * @param title
	 *            the entry title, <b>null</b> if none.
	 * 
	 */
	 ...
	 *            the list of Link elements with the entry alternate links to
	 ...
	 * 
	 * @param otherLinks
	 *            the list Link elements with the entry non-alternate links to
	 *            set, an empty list or <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param authors
	 *            the author of the entry, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param contributors
	 *            the list of Person elements with the entry contributors to
	 *            set, an empty list or <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param modified
	 *            the entry modified date, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param issued
	 *            the entry issued date, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param created
	 *            the entry created date, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param summary
	 *            the entry summary, <b>null</b> if none.
	 * 
	 */
