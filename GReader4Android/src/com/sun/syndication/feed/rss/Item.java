...
public class Item implements Cloneable, Serializable, Extendable {
	 ...
	 * 
	 * @param link
	 *            the item link to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param uri
	 *            the item uri to set, <b>null</b> if none.
	 */
	 ...
	 * 
	 * @param description
	 *            the item description to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param content
	 *            the item content to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param source
	 *            the item source to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param enclosures
	 *            the list of Enclosure elements with the item enclosures to
	 ...
	 * 
	 * @param categories
	 *            the list of Categories elements with the item categories to
	 *            set, an empty list or <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param guid
	 *            the item GUID to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param comments
	 *            the item comments to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param author
	 *            the item author to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param pubDate
	 *            the item publishing date to set, <b>null</b> if none.
	 * 
	 */
