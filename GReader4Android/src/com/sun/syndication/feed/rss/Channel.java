...
public class Channel extends WireFeed {
	 ...
	 * 
	 * @param title
	 *            the channel title to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param description
	 *            the channel description to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param image
	 *            the channel image to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param items
	 *            the list of Item elements with the channel items to set, an
	 ...
	 * 
	 * @param textInput
	 *            the channel text input to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param rating
	 *            the channel rating to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param pubDate
	 *            the channel publishing date to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param lastBuildDate
	 *            the channel last build date to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param docs
	 *            the channel docs to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 *            the channel managing editor to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param webMaster
	 *            the channel web master to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param skipHours
	 *            the list of Integer elements with the channel skip hours to
	 ...
	 * 
	 * @param skipDays
	 *            the list of Day elements with the channel skip days to set, an
	 *            empty list or <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param categories
	 *            the list of Category elements with the channel categories to
	 *            set, an empty list or <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param generator
	 *            the channel generator to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param ttl
	 *            the channel time to live to set, <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param modules
	 *            the list of ModuleImpl elements with the channel modules to
	 *            set, an empty list or <b>null</b> if none.
	 * 
	 */
