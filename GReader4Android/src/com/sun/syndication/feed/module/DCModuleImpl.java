...
public class DCModuleImpl extends ModuleImpl implements DCModule {
	 ...
	 * 
	 * @param creators
	 *            the list of String representing the DublinCore module creators
	 *            to set, an empty list or <b>null</b> if none.
	 * 
	 */
	 ...
	 * 
	 * @param subjects
	 *            the list of DCSubject elements with the DublinCore module
	...
	public DCSubject getSubject() {
		return ((_subject != null) && (_subject.size() > 0)) ? (DCSubject) _subject.get(0) : null;
	}
	...
	public String getDescription() {
		return ((_description != null) && (_description.size() > 0)) ? (String) _description.get(0) : null;
	}
	...
	public String getPublisher() {
		return ((_publisher != null) && (_publisher.size() > 0)) ? (String) _publisher.get(0) : null;
	}
	...
	public String getContributor() {
		return ((_contributors != null) && (_contributors.size() > 0)) ? (String) _contributors.get(0) : null;
	}
	 ...
	 * 
	 * @param dates
	 *            the list of Date representing the DublinCore module dates to
	 ...
	 */
	public Date getDate() {
		return ((_date != null) && (_date.size() > 0)) ? (Date) _date.get(0) : null;
	}
	...
	public String getType() {
		return ((_type != null) && (_type.size() > 0)) ? (String) _type.get(0) : null;
	}
	 ...
	 * 
	 * @param formats
	 *            the list of String representing the DublinCore module formats
	 *            to set, an empty list or <b>null</b> if none.
	 * 
	 */
	...
	public String getFormat() {
		return ((_format != null) && (_format.size() > 0)) ? (String) _format.get(0) : null;
	}
	...
	public String getIdentifier() {
		return ((_identifier != null) && (_identifier.size() > 0)) ? (String) _identifier.get(0) : null;
	}
	 ...
	 * 
	 * @param sources
	 *            the list of String representing the DublinCore module sources
	 *            to set, an empty list or <b>null</b> if none.
	 * 
	 */
	...
	public String getSource() {
		return ((_source != null) && (_source.size() > 0)) ? (String) _source.get(0) : null;
	}
	...
	public String getLanguage() {
		return ((_language != null) && (_language.size() > 0)) ? (String) _language.get(0) : null;
	}
	...
	public String getRelation() {
		return ((_relation != null) && (_relation.size() > 0)) ? (String) _relation.get(0) : null;
	}
	...
	public String getCoverage() {
		return ((_coverage != null) && (_coverage.size() > 0)) ? (String) _coverage.get(0) : null;
	}
	 ...
	 * 
	 * @param rights
	 *            the list of String representing the DublinCore module rights
	 *            to set, an empty list or <b>null</b> if none.
	 * 
	 */
	...
	public String getRights() {
		return ((_rights != null) && (_rights.size() > 0)) ? (String) _rights.get(0) : null;
	}
