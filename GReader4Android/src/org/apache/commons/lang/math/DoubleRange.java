...
/**
 * <p>
 * <code>DoubleRange</code> represents an inclusive range of <code>double</code>
 * s.
 * </p>
 * 
...
public final class DoubleRange extends Range implements Serializable {
	...
	/**
	 * <p>
	 * Constructs a new <code>DoubleRange</code> using the specified number as
	...
	/**
	 * <p>
	 * Constructs a new <code>DoubleRange</code> with the specified minimum and
	...
	public boolean equals(Object obj) {
		...
		return (Double.doubleToLongBits(min) == Double.doubleToLongBits(range.min) && Double.doubleToLongBits(max) == Double
				.doubleToLongBits(range.max));
	}
