...
public final class FloatRange extends Range implements Serializable {
	...
	/**
	 * <p>
	 * Constructs a new <code>FloatRange</code> using the specified number as
	...
	/**
	 * <p>
	 * Constructs a new <code>FloatRange</code> with the specified minimum and
	...
	public boolean equals(Object obj) {
		...
		return (Float.floatToIntBits(min) == Float.floatToIntBits(range.min) && Float.floatToIntBits(max) == Float
				.floatToIntBits(range.max));
	}
