...
/**
 * <p>
 * <code>Fraction</code> is a <code>Number</code> implementation that stores
 * fractions accurately.
 * </p>
 * 
 * <p>
 * This class is immutable, and interoperable with most methods that accept a
 * <code>Number</code>.
 * </p>
 * 
 ...
 * @since 2.0
 * @version $Id: Fraction.java 905636 2010-02-02 14:03:32Z niallp $
 */
public final class Fraction extends Number implements Comparable {
	...
	/**
	 * The denominator number part of the fraction (the seven in three
	 * sevenths).
	 */
	...
	/**
	 * <p>
	 * Constructs a <code>Fraction</code> instance with the 2 parts of a
	 * fraction Y/Z.
	 * </p>
	 * 
	 * @param numerator
	...
	/**
	 * <p>
	 * Creates a <code>Fraction</code> instance with the 2 parts of a fraction
	 * Y/Z.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Creates a <code>Fraction</code> instance with the 3 parts of a fraction X
	 * Y/Z.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param whole
	 *            the whole number, for example the one in 'one and three
	 *            sevenths'
	 * @param numerator
	 *            the numerator, for example the three in 'one and three
	 *            sevenths'
	 * @param denominator
	 *            the denominator, for example the seven in 'one and three
	 *            sevenths'
	 * @return a new fraction instance
	 * @throws ArithmeticException
	 *             if the denomiator is <code>zero</code>
	...
	/**
	 * <p>
	 * Creates a reduced <code>Fraction</code> instance with the 2 parts of a
	 * fraction Y/Z.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Creates a <code>Fraction</code> instance from a <code>double</code>
	 * value.
	 * </p>
	 * 
	 * <p>
	 * This method uses the <a
	 * href="http://archives.math.utk.edu/articles/atuyl/confrac/"> continued
	 * fraction algorithm</a>, computing a maximum of 25 convergents and
	 * bounding the denominator by 10,000.
	 * </p>
	 * 
	 * @param value
	 ...
	 * @throws ArithmeticException
	 *             if <code>|value| > Integer.MAX_VALUE</code> or
	 *             <code>value = NaN</code>
	 * @throws ArithmeticException
	 ...
	 * 
	 * <p>
	 * If the fraction is negative such as -7/4, it can be resolved into -1 3/4,
	 * so this method returns the positive proper numerator, 3.
	 * </p>
	 * 
	 ...
	 * <p>
	 * If the fraction is negative such as -7/4, it can be resolved into -1 3/4,
	 * so this method returns the positive whole part -1.
	 * </p>
	 * 
	 * @return the whole fraction part of a proper fraction, that includes the
	 *         sign
	 */
	...
	/**
	 * <p>
	 * Gets the fraction as an <code>int</code>. This returns the whole number
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>long</code>. This returns the whole number
	 * part of the fraction.
	 * </p>
	 * 
	 * @return the whole number fraction part
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>float</code>. This calculates the fraction
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>double</code>. This calculates the fraction
	 * as the numerator divided by denominator.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * For example, if this fraction represents 2/4, then the result will be
	 * 1/2.
	 * </p>
	 * 
	 ...
	 * @return <code>this</code> if the power is one, <code>ONE</code> if the
	 *         power is zero (even if the fraction equals ZERO) or a new
	 *         fraction instance raised to the appropriate power
	 * @throws ArithmeticException
	...
	public Fraction multiplyBy(Fraction fraction) {
		...
		return getReducedFraction(mulAndCheck(numerator / d1, fraction.numerator / d2), mulPosAndCheck(denominator / d2,
	 ...
	 * because, for example, equals treats 1/2 and 2/4 as different, whereas
	 * compareTo treats them as equal.
	 * 
	 * @param object
	 ...
	 * 
	 * <p>
	 * The format used in '<i>wholeNumber</i>
	 * <i>numerator</i>/<i>denominator</i>'. If the whole number is zero it will
	 * be ommitted. If the numerator is zero, only the whole number is returned.
	 * </p>
	 * 
	 * @return a <code>String</code> form of the fraction
	 */
		...
		if (toProperString == null) {
			if (numerator == 0) {
				...
				if (properNumerator == 0) {
					...
					toProperString = new StringBuffer(32).append(getProperWhole()).append(' ').append(properNumerator).append('/').append(
							getDenominator()).toString();
				}
			} else {
