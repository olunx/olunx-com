...
/**
 * <p>
 * <code>JVMRandom</code> is a wrapper that supports all possible Random methods
 * via the {@link java.lang.Math#random()} method and its system-wide
 * {@link Random} object.
 * </p>
 * <p>
 * It does this to allow for a Random class in which the seed is shared between
 * all members of the class - a better name would have been SharedSeedRandom.
 * <p>
 * <b>N.B.</b> the current implementation overrides the methods
 * {@link Random#nextInt(int)} and {@link Random#nextLong()} to produce positive
 * numbers ranging from 0 (inclusive) to MAX_VALUE (exclusive).
 * 
 * @since 2.0
...
public final class JVMRandom extends Random {
	 ...
	 * Unsupported in 2.0.
	 * 
	 * @return Nothing, this method always throws an
