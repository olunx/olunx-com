 ...
 * and {@link org.apache.commons.lang.exception.NestableRuntimeException
...
public class NestableDelegate implements Serializable {
	 ...
	 * calling code, typically in initialisation. This exists for backwards
	 * compatability, setting it to false will return the library to v1.0
	 * behaviour (but will affect all users of the library in the classloader).
	 * 
	 * @since 2.0
	 */
	...
	/**
	 * Whether to match subclasses via indexOf. This public flag may be set by
	 * calling code, typically in initialisation. This exists for backwards
	 * compatability, setting it to false will return the library to v2.0
	 * behaviour (but will affect all users of the library in the classloader).
	 * 
	 * @since 2.1
	 */
	 ...
	 *            where <code>super</code> is an instance of
	 *            {@link java.lang.Throwable}.
	...
	/**
	 * Returns the <code>Throwable</code> in the chain of <code>Throwable</code>
	 ...
	 * <code>Throwable</code>s with an index greater than or equal to the
	 * specified index. The method returns -1 if the specified type is not found
	 * in the chain.
	 * <p>
	 * NOTE: From v2.1, we have clarified the <code>Nestable</code> interface
	 * such that this method matches subclasses. If you want to NOT match
	 * subclasses, please use
	 * {@link ExceptionUtils#indexOfThrowable(Throwable, Class, int)} (which is
	 * avaiable in all versions of lang). An alternative is to use the public
	 * static flag {@link #matchSubclasses} on <code>NestableDelegate</code>,
