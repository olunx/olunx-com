...
public class ExceptionUtils {
	...
	/**
	 * <p>
	 * Sets the cause of a <code>Throwable</code> using introspection, allowing
	 ...
	 * <code>Throwable</code> objects include the given name.
	 * </p>
	 * 
	 * @param methodName
	 *            the methodName to search in the list.
	 * @return if the list of method names used in the search for
	 *         <code>Throwable</code> objects include the given name.
	 * @since 2.1
	 */
	 ...
	 * exceptions, including those from JDK 1.4, and
