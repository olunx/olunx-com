 ...
 * @author Gary Gregory
 * @since 2.0
 * @version $Id: BooleanUtils.java 905636 2010-02-02 14:03:32Z niallp $
 */
public class BooleanUtils {

	/**
	 * <p>
	 * <code>BooleanUtils</code> instances should NOT be constructed in standard
	 ...
	 * 
	 * <p>
	 * <code>'true'</code>, <code>'on'</code> or <code>'yes'</code> (case insensitive) will return <code>true</code>. <code>'false'</code>, <code>'off'</code> or <code>'no'</code> (case insensitive) will return
	...
	/**
	 * <p>
	 * Converts a Boolean to a String returning <code>'true'</code>, <code>'false'</code>, or
	 * <code>null</code>.
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * <p>
	 * Converts a boolean to a String returning <code>'true'</code> or <code>'false'</code>.
	 * </p>
	 * 
	 * <pre>
	 ...
	 *             if <code>array</code> is empty.
	 * @throws IllegalArgumentException
	 *             if <code>array</code> contains a <code>null</code>
	 */
	public static Boolean xor(Boolean[] array) {
		if (array == null) {
			throw new IllegalArgumentException("The Array must not be null");
