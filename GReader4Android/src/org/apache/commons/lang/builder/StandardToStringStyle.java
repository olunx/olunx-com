 ...
 * instantiate a new style each time. Simply instantiate the class once,
 * customize the values as required, and store the result in a public static
 * final variable for the rest of the program to access.
 * </p>
 * 
...
public class StandardToStringStyle extends ToStringStyle {
	 ...
	 * 
	 * @param nullText
	 *            the new text to output when <code>null</code> found
	 */
	...
	/**
	 * <p>
	 * Gets the text to output when a <code>Collection</code>, <code>Map</code>
	 * or <code>Array</code> size is output.
	 * </p>
	 * 
	 * <p>
	 ...
	 * <code>Map</code> or <code>Array</code> size is output.
	 * </p>
	 * 
	 * <p>
	 * This is output before the size value.
