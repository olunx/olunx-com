 ...
 * 
 * <p>
 * This class enables a good and consistent <code>toString()</code> to be built
 ...
 * other object), use {@link #appendToString}.
 * </p>
 * 
 * <p>
...
public class ToStringBuilder {
	 ...
	 * startup. It is recommended to pass a <code>ToStringStyle</code> to the
	 * constructor instead of using this global default.
	 * </p>
	 * 
	 * <p>
	 * This method can be used from multiple threads. Internally, a
	 * <code>volatile</code> variable is used to provide the guarantee that the
	 * latest value set using {@link #setDefaultStyle} is the value returned. It
	 * is strongly recommended that the default style is only changed during
	 * application startup.
	 * </p>
	 * 
	 * <p>
	 * One reason for changing the default could be to have a verbose style
	 * during development and a compact style in production.
	 * </p>
	 * 
	 ...
	 * <code>volatile</code> variable is used to provide the guarantee that the
	 * latest value set is the value returned from {@link #getDefaultStyle}.
	 * </p>
	 * 
	 * @param style
	 ...
	 * 
	 * @param object
	 *            the Object to build a <code>toString</code> for, not
	...
	/**
	 * <p>
	 * Constructs a builder for the specified object using the a defined output
	 * style.
	 * </p>
	 * 
	 * <p>
	 ...
	 *            recommended to be null
	 * @param style
	 *            the style of the <code>toString</code> to create, null uses
	 *            the default style
	 */
	 ...
	 *            the default style
	 * @param buffer
	 *            the <code>StringBuffer</code> to populate, may be null
	 */
     ...
     * </code> method. Appends the
	 * class name followed by {@link System#identityHashCode(java.lang.Object)}.
	 * </p>
	 * 
	 * @param object
	 ...
	 * <code>toString()</code> on the other class and pass the result into this
	 * method.
	 * </p>
	 * 
	 * <pre>
