 ...
 * exception supplements <code>UnsupportedOperationException</code> by providing
 * a more semantically rich description of the problem.
 * </p>
 * 
 * <p>
 * <code>NotImplementedException</code> represents the case where the author has
 * yet to implement the logic at this point in the program. This can act as an
 * exception based TODO tag. Because this logic might be within a catch block,
 * this exception suports exception chaining.
 * </p>
 * 
 * <pre>
 * public void foo() {
...
public class NotImplementedException extends UnsupportedOperationException implements Nestable {
	 ...
	 * 
	 * @param index
	 *            the index of the <code>Throwable</code> in the chain
	 ...
	 * objects. Each throwable returns a message, a null string is included in
	 * the array if there is no message for a particular <code>Throwable</code>.
	 * 
	...
	/**
	 * Returns the index of the first occurrence of the specified type. If there
	 * is no match, <code>-1</code> is returned.
	 * 
	 * @param type
	 ...
	 * from the specified index. If there is no match, <code>-1</code> is
	 * returned.
	 * 
	 * @param type
	 *            the type to search for
	...
	/**
	 * Prints the stack trace of this exception. Includes information from the
