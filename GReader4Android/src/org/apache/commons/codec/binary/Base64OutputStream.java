 ...
 * size). When encoding the default lineLength is 76 characters and the default
...
public class Base64OutputStream extends FilterOutputStream {
	 ...
	 *            should decode.
	 * @param lineLength
	 *            If doEncode is true, each line of encoded data will contain
	 *            lineLength characters (rounded down to nearest multiple of 4).
	 ...
	 *            <= 0, the lineSeparator is not used. If doEncode is false
	 ...
	 * starting at <code>offset</code> to this output stream.
	 * 
	 * @param b
	 *            source byte array
	 * @param offset
	 ...
	 * written out to the stream. If propogate is true, the wrapped stream will
	 * also be flushed.
	 * 
	 * @param propogate
	 *            boolean flag to indicate whether the wrapped OutputStream
