...
abstract class RFC1522Codec {
	 ...
	 * with the given charset. This method constructs the "encoded-word" header
	 * common to all the RFC 1522 codecs and then invokes
	 ...
	 * text. This method processes the "encoded-word" header common to all the
	 * RFC 1522 codecs and then invokes {@link #doEncoding(byte [])} method of a
	 * concrete class to perform the specific deconding.
	 * 
	 * @param text
	 *            a string to decode
