...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
	...
	/**
	 * The default charset used for string decoding and encoding. Consider this
	 * field final. The next major release may break compatibility and make this
	 * field be final.
	 */
	protected String charset;

	/**
	 * Consider this field final. The next major release may break compatibility
	 * and make this field be final.
	 */
	...
	/**
	 * Decodes a URL safe string into its original form using the default string
	 * charset. Escaped characters are converted back to their original
	 * representation.
	 * 
	 * @param pString
	 *            URL safe string to convert into its original form
