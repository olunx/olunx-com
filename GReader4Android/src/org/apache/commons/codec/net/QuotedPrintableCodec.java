...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
	...
	/**
	 * Decodes a quoted-printable string into its original form using the
	 * default string charset. Escaped characters are converted back to their
	 * original representation.
	 * 
	 * @param pString
	 *            quoted-printable string to convert into its original form
	...
	/**
	 * Encodes an object into its quoted-printable safe form. Unsafe characters
	 * are escaped.
	 * 
	 * @param pObject
	 ...
	 *             objects of this type or if encoding is unsuccessful
	 */
