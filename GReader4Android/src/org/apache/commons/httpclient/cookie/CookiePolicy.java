...
public abstract class CookiePolicy {
	...
	/**
	 * The <tt>COMPATIBILITY</tt> policy provides high compatibilty with common
	 * cookie management of popular HTTP agents.
	 * 
	 ...
	 * @return cookie specification interface intended for processing cookies
