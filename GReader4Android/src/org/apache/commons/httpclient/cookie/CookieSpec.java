...
public interface CookieSpec {
	 ...
	 * 
	 * @param host
	 *            the host which sent the <tt>Set-Cookie</tt> header
	 * @param port
	 *            the port which sent the <tt>Set-Cookie</tt> header
	 * @param path
	 *            the path which sent the <tt>Set-Cookie</tt> header
	 * @param secure
	 ...
	 */
	Cookie[] parse(String host, int port, String path, boolean secure, final String header) throws MalformedCookieException,
	 ...
	 *             if an input parameter is illegal
	 */
	Cookie[] parse(String host, int port, String path, boolean secure, final Header header) throws MalformedCookieException,
			IllegalArgumentException;
	 ...
	 * 
	 * @param attribute
	 *            cookie attribute from the <tt>Set-Cookie</tt>
	 * @param cookie
	 *            the to be updated
	 * @throws MalformedCookieException
	 *             if an exception occurs during parsing
	...
	/**
	 * Validate the cookie according to validation rules defined by the cookie
	 * specification.
	 * 
	 * @param host
	 ...
	 *             if an input parameter is illegal
	 */
	void validate(String host, int port, String path, boolean secure, final Cookie cookie) throws MalformedCookieException,
			IllegalArgumentException;

	/**
	 * Sets the {@link Collection} of date patterns used for parsing. The String
	 * patterns must be compatible with {@link java.text.SimpleDateFormat}.
	 * 
	 * @param datepatterns
	...
	/**
	 * Returns the {@link Collection} of date patterns used for parsing. The
	 ...
	 */
	boolean match(String host, int port, String path, boolean secure, final Cookie cookie);
	 ...
	 *         with given attributes, <tt>false</tt> otherwise.
	 */
	Cookie[] match(String host, int port, String path, boolean secure, final Cookie cookies[]);
	 ...
	 * 
	 * @param cookie
	 *            the Cookie format as a <tt>Cookie</tt> header
