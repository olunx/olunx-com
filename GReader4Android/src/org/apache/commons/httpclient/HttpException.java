...
public class HttpException extends IOException {
	 ...
	 * 
	 * @param s
	 *            the <tt>PrintStream</tt> to which the exception and its stack
	 ...
	 * 
	 * @param s
	 *            the <tt>PrintWriter</tt> to which the exception and its stack
	 *            trace should be written
	 * 
	 * @since 3.0
	 */
	 ...
	 * 
	 * @param code
	 *            The reason for the exception. This is intended to be an HTTP
	 *            status code.
	 * 
	 * @deprecated HttpClient no longer uses this for itself. It is only
	 *             provided for compatibility with existing clients, and will be
	 ...
	 * 
	 * @deprecated HttpClient no longer uses this field for itself. It is only
	 *             provided for compatibility with existing clients.
	 */
