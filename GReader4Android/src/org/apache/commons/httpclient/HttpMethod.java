...
public interface HttpMethod {
	 ...
	 * 
	 * @param queryString
	 *            the query to be used in the request, with no leading '?'
	 *            character
	 * 
	 * @see #getQueryString()
	 ...
	 *            string. The name/value pairs will be automatically URL encoded
	 *            and should not have been encoded previously.
	 * 
	 * @see #getQueryString()
	 * @see #setQueryString(String)
	 * @see org.apache.commons.httpclient.util.EncodingUtil#formUrlEncode(NameValuePair[],
	 *      String)
	 */
