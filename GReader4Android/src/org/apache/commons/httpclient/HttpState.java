...
public class HttpState {
	 ...
	 * 
	 * @deprecated This field and feature will be removed following HttpClient
	 *             3.0.
	 */
	...
	/**
	 * Returns an array of {@link Cookie cookies} in this HTTP state that match
	 ...
	 *            the request path
	 * @param secure
	 *            <code>true</code> when using HTTPS
	 * 
	 * @return an array of {@link Cookie cookies}.
	 * 
	 * @see #getCookies()
	...
	/**
	 * Returns the current {@link CookiePolicy cookie policy} for this HTTP
	 * state.
	 * 
	 ...
	 * 
	 * @param value
	 *            <tt>true</tt> if preemptive authentication should be
	...
	/**
	 * Returns <tt>true</tt> if preemptive authentication should be attempted,
	...
	/**
	 * Sets the current {@link CookiePolicy cookie policy} for this HTTP state
	 * to one of the following supported policies:
	 * {@link CookiePolicy#COMPATIBILITY}, {@link CookiePolicy#NETSCAPE_DRAFT}
	 * or {@link CookiePolicy#RFC2109}.
	 * 
	 * @param policy
	 *            new {@link CookiePolicy cookie policy}
	 * 
	 * @deprecated Use
	 *             {@link org.apache.commons.httpclient.params.HttpMethodParams#setCookiePolicy(String)}
	 *             , {@link HttpMethod#getParams()}.
	 */
	 ...
	 * @param host
	 *            the host the realm belongs to
	 * @param credentials
	 *            the authentication {@link Credentials credentials} for the
	 *            given realm.
	 * 
	 ...
	 * scope on the given host.
	 * 
	 * If the <i>realm</i> exists on <i>host</i>, return the coresponding
	 * credentials. If the <i>host</i> exists with a <tt>null</tt> <i>realm</i>,
	 * return the corresponding credentials. If the <i>realm</i> exists with a
	 * <tt>null</tt> <i>host</i>, return the corresponding credentials. If the
	 * <i>realm</i> does not exist, return the default Credentials. If there are
	...
	/**
	 * Sets the {@link Credentials credentials} for the given proxy
	 * authentication realm on the given proxy host. The <code>null</code> proxy
	 * realm signifies default credentials for the given proxy host, which
	 * should be used when no {@link Credentials credentials} have been
	 * explictly supplied for the challenging proxy realm. The <code>null</code>
	 * proxy host signifies default credentials, which should be used when no
	 * {@link Credentials credentials} have been explictly supplied for the
	 * challenging proxy host. Any previous credentials for the given proxy
	 * realm on the given proxy host will be overwritten.
	 * 
	 * @param realm
	 *            the authentication realm
	 * @param proxyHost
