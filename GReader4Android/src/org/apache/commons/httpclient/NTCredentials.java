...
/**
 * {@link Credentials} for use with the NTLM authentication scheme which requires
...
public class NTCredentials extends UsernamePasswordCredentials {
	 ...
	 * 
	 * @param userName
	 *            The user name. This should not include the domain to
	 *            authenticate with. For example: "user" is correct whereas
	 *            "DOMAIN\\user" is not.
	 * @param password
	 *            The password.
	 * @param host
	 ...
	 * 
	 * @return String the domain these credentials are intended to authenticate
	 *         with.
	 * 
	...
	/**
	 * Sets the host name of the computer originating the request. The host name
	 * may not be null.
	 * 
	 * @param host
