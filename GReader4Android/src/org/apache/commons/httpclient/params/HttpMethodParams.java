...
public class HttpMethodParams extends DefaultHttpParams {
	...
	/**
	 * Defines whether {@link org.apache.commons.httpclient.HttpMethod HTTP
	 * methods} should reject ambiguous
	 * {@link org.apache.commons.httpclient.StatusLine HTTP status line}.
	 * <p>
	...
	/**
	 * Defines whether {@link org.apache.commons.httpclient.Cookie cookies}
	 * should be put on a single {@link org.apache.commons.httpclient.Header
	 * response header}.
	 * <p>
	 * This parameter expects a value of type {@link Boolean}.
	 * </p>
	 ...
	 * {@link org.apache.commons.httpclient.methods.HeadMethod} should be
	 * rejected.
	 * <p>
	 * This parameter expects a value of type {@link Boolean}.
	 * </p>
	 ...
	 * response to {@link org.apache.commons.httpclient.methods.HeadMethod HEAD
	 * method} from a non-compliant server. If the parameter is not set or set
	 * to <tt>-1</tt> non-compliant response body check is disabled.
	 * <p>
	 ...
	 * {@link org.apache.commons.httpclient.methods.ExpectContinueMethod entity
	 * enclosing methods}. The purpose of the 'Expect: 100-Continue' handshake
	 ...
	 * {@link org.apache.commons.httpclient.Credentials}. If not defined then
	 * the {@link #HTTP_ELEMENT_CHARSET} should be used.
	 * <p>
	 * This parameter expects a value of type {@link String}.
	 * </p>
	 */
	 ...
	 * {@link org.apache.commons.httpclient.Credentials}. If not configured the
	 * {@link #HTTP_ELEMENT_CHARSET HTTP element charset} is used.
	 * 
	 * @return The charset
	 */
	 ...
	 * {@link org.apache.commons.httpclient.HttpMethod HTTP methods} that this
	 ...
	 * {@link org.apache.commons.httpclient.HttpMethod HTTP methods} this
	 * collection of parameters applies to.
	 * 
	...
	private static final String[] PROTOCOL_STRICTNESS_PARAMETERS = { UNAMBIGUOUS_STATUS_LINE, SINGLE_COOKIE_HEADER,
			STRICT_TRANSFER_ENCODING, REJECT_HEAD_BODY, WARN_EXTRA_INPUT };
