...
public class HttpClient {
	 ...
	 *            the {@link HttpMethod HTTP method} to execute.
	 * @param state
	 *            the {@link HttpState HTTP state} to use when executing the
	 *            method. If <code>null</code>, the state returned by
	 *            {@link #getState} will be used.
	 * 
	 * @return the method's response code
	 * 
	 * @throws IOException
	...
	public int executeMethod(HostConfiguration hostconfig, final HttpMethod method, final HttpState state) throws IOException,
		...
		HttpMethodDirector methodDirector = new HttpMethodDirector(getHttpConnectionManager(), hostconfig, this.params,
	 ...
	 * 
	 * @param httpConnectionManager
	 *            The {@link HttpConnectionManager HTTP connection manager} to
	 *            set
	 * 
	 * @since 2.0
	 */
