	...
	public static void shutdownAll() {
		...
		synchronized (REFERENCE_TO_CONNECTION_SOURCE) {
			...
			synchronized (ALL_CONNECTION_MANAGERS) {
				...
				MultiThreadedHttpConnectionManager[] connManagers = (MultiThreadedHttpConnectionManager[]) ALL_CONNECTION_MANAGERS.keySet()
						.toArray(new MultiThreadedHttpConnectionManager[ALL_CONNECTION_MANAGERS.size()]);
