...
public class StringRequestEntity implements RequestEntity {
	 ...
	 *            The content to set.
	 * @param contentType
	 *            The type of the content, or <code>null</code>. The value
	 *            retured by {@link #getContentType()}. If this content type
	 *            contains a charset and the charset parameter is null, the
	 *            content's type charset will be used.
	 * @param charset
	 *            The charset of the content, or <code>null</code>. Used to
	 *            convert the content to bytes. If the content type does not
	 *            contain a charset and charset is not null, then the charset
	 *            will be appended to the content type.
	 */
