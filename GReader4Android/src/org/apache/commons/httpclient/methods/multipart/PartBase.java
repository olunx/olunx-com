...
public abstract class PartBase extends Part {
	 ...
	 * 
	 * @param charSet
	 *            the character encoding, or <code>null</code> to exclude the
	 ...
	 * 
	 * @param contentType
	 *            the content type, or <code>null</code> to exclude the content
	 *            type header
	 */
	 ...
	 * 
	 * @param transferEncoding
	 *            the transfer encoding, or <code>null</code> to exclude the
