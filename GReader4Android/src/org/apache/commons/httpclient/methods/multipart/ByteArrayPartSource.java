...
/**
 * A PartSource that reads from a byte array. This class should be used when the
 * data to post is already loaded into memory.
 * 
...
public class ByteArrayPartSource implements PartSource {
	 ...
	 * 
	 * @param fileName
	 *            the name of the file these bytes represent
	 * @param bytes
