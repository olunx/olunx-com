...
public abstract class Part {
	 ...
	 * 
	 * @deprecated use
	 *             {@link org.apache.commons.httpclient.params.HttpMethodParams#MULTIPART_BOUNDARY}
	 */
	...
	/**
	 * The default boundary to be used if {@link #setBoundaryBytes(byte[])) has
	 * not been called.
	 */
	 ...
	 * {@link Part#sendParts(OutputStream, Part[], byte[])} and
	 * {@link Part#getLengthOfParts(Part[], byte[])}
	 * 
	 * @param boundaryBytes
	...
	/**
	 * Write all the data to the output stream. If you override this method make
	 * sure to override #length() as well
	 * 
	 * @param out
	 *            The output stream
	 * @throws IOException
	...
	/**
	 * Return the full length of all the data. If you override this method make
	 * sure to override #send(OutputStream) as well
	 * 
	 * @return long The length.
	 * @throws IOException
	 *             If an IO problem occurs
