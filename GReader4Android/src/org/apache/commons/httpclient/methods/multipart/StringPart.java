...
public class StringPart extends PartBase {
	 ...
	 *            the string to post
	 * @param charset
	 *            the charset to be used to encode the string, if
	 *            <code>null</code> the {@link #DEFAULT_CHARSET default} is used
	 */
	...
	/**
	 * Gets the content in bytes. Bytes are lazily created to allow the charset
	 * to be changed after the part is created.
	 * 
	 ...
	 * 
	 * @see
	 * org.apache.commons.httpclient.methods.multipart.BasePart#setCharSet(java
	 * .lang.String)
	 */
