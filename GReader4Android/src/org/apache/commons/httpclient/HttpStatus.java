...
public class HttpStatus {
	...
	private static final String[][] REASON_PHRASES = new String[][] { new String[0], new String[3], new String[8], new String[8],
	...
	public static String getStatusText(int statusCode) {
		...
		if (classIndex < 1 || classIndex > (REASON_PHRASES.length - 1) || codeIndex < 0
				|| codeIndex > (REASON_PHRASES[classIndex].length - 1)) {
			return null;
		}
