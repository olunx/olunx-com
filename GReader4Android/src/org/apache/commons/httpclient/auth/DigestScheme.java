 ...
 * {@link org.apache.commons.httpclient.params.HttpMethodParams#CREDENTIAL_CHARSET
 ...
 * {@link org.apache.commons.httpclient.params.HttpMethodParams#HTTP_ELEMENT_CHARSET
...
public class DigestScheme extends RFC2617Scheme {
	...
	private String createDigest(final String uname, final String pwd) throws AuthenticationException {
		...
		if (qopVariant == QOP_MISSING) {
			...
			StringBuffer tmp2 = new StringBuffer(md5a1.length() + nonce.length() + NC.length() + cnonce.length() + qopOption.length()
					+ md5a2.length() + 5);
			tmp2.append(md5a1);
			tmp2.append(':');
			tmp2.append(nonce);
