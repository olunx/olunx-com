...
public class AuthScope {
	 ...
	 * 
	 * @param host
	 *            the host the credentials apply to. May be set to <tt>null</tt>
	 *            if credenticals are applicable to any host.
	 * @param port
	 *            the port the credentials apply to. May be set to negative
	 *            value if credenticals are applicable to any port.
	 * @param realm
	 *            the realm the credentials apply to. May be set to
	 *            <tt>null</tt> if credenticals are applicable to any realm.
	 * @param scheme
	 *            the authentication scheme the credentials apply to. May be set
	 *            to <tt>null</tt> if credenticals are applicable to any
	...
	/**
	 * Creates a new credentials scope for the given <tt>host</tt>,
	 * <tt>port</tt>, <tt>realm</tt>, and any authentication scheme.
	 * 
	 * @param host
	 *            the host the credentials apply to. May be set to <tt>null</tt>
	 *            if credenticals are applicable to any host.
	...
	public boolean equals(Object o) {
		...
		return paramsEqual(this.host, that.host) && paramsEqual(this.port, that.port) && paramsEqual(this.realm, that.realm)
