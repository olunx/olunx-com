 ...
 * depth of the last symbolic element in the path field of the Request-URI also
 ...
 * receipt of another challenge from the server. Similarly, when a client sends
 * a request to a proxy, it may reuse a userid and password in the
 * Proxy-Authorization header field without receiving another challenge from the
 * proxy server. </blockquote> </p>
 * 
...
public final class HttpAuthenticator {
	...
	/**
	 * Chooses the strongest authentication scheme supported from the array of
	 * authentication challenges. Currently only <code>NTLM</code>,
	 * <code>Digest</code>, <code>Basic</code> schemes are recognized. The
	 * <code>NTLM</code> scheme is considered the strongest and is preferred to
	 * all others. The <code>Digest</code> scheme is preferred to the
	 * <code>Basic</code> one which provides no encryption for credentials. The
	 * <code>Basic</code> scheme is used only if it is the only one supported.
	 * 
	 * @param challenges
	...
	/**
	 * Attempt to provide default authentication credentials to the given method
	 * in the given context using basic authentication scheme.
	 * 
	 * @param method
	 *            the HttpMethod which requires authentication
	 * @param conn
	 *            the connection to a specific host. This parameter may be
	 *            <tt>null</tt> if default credentials (not specific to any
	 *            particular host) are to be used
	 * @param state
	...
	/**
	 * Attempt to provide default proxy authentication credentials to the given
	 * method in the given context using basic authentication scheme.
	 * 
	 * @param method
	 *            the HttpMethod which requires authentication
	 * @param conn
	 ...
	 *            the HttpState object providing Credentials
	 * 
	 * @return true if the <tt>Proxy-Authenticate</tt> response header was added
	 * 
	 * @throws InvalidCredentialsException
	 *             if authentication credentials are not valid or not applicable
	 *             for basic scheme
	...
	/**
	 * Attempt to provide requisite authentication credentials to the given
	 * method in the given context using the given authentication scheme.
	 * 
	 * @param authscheme
	 ...
	 *             if authentication credentials required to respond to the
	 *             authentication challenge are not available
	 * @throws AuthenticationException
	 *             when a parsing or other error occurs
	 * 
	 * @see HttpState#setCredentials(String,String,Credentials)
	...
	/**
	 * Attempt to provide requisite proxy authentication credentials to the
	 * given method in the given context using the given authentication scheme.
	 * 
	 * @param authscheme
	 *            The authentication scheme to be used
	 * @param method
