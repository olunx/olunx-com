...
public interface AuthScheme {
	...
	/**
	 * Returns authentication realm. If the concept of an authentication realm
	 * is not applicable to the given authentication scheme, returns
	 * <code>null</code>.
	 * 
	 ...
	 *             {@link Credentials}, method name and URI using the given
	 *             authentication scheme in response to the actual authorization
	 *             challenge.
	 * 
	 * @param credentials
	 *            The set of credentials to be used for athentication
	 * @param method
	 *            The name of the method that requires authorization. This
	 *            parameter may be ignored, if it is irrelevant or not
	 *            applicable to the given authentication scheme
	 * @param uri
	 *            The URI for which authorization is needed. This parameter may
	 *            be ignored, if it is irrelevant or not applicable to the given
	 *            authentication scheme
