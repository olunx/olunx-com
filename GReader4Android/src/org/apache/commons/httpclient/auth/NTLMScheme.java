 ...
 * For a detailed explanation of the NTLM scheme please see <a
...
public class NTLMScheme implements AuthScheme {
	...
	/**
	 * Create a NTLM authorization string for the given challenge and NT
	 * credentials.
	 * 
	 * @param challenge
	 *            The challenge.
	...
	public static String authenticate(final NTCredentials credentials, final String challenge) throws AuthenticationException {
		...
		NTLM ntlm = new NTLM();
		String s = ntlm.getResponseFor(challenge, credentials.getUserName(), credentials.getPassword(), credentials.getHost(), credentials
				.getDomain());
		return "NTLM " + s;
	}
	 ...
	 * @since 3.0
	 */
	public static String authenticate(final NTCredentials credentials, final String challenge, String charset)
			throws AuthenticationException {
	 ...
	 * @param method
	 *            Method name is ignored by the NTLM authentication scheme
	 * @param uri
	...
	public String authenticate(Credentials credentials, HttpMethod method) throws AuthenticationException {
		...
		if (this.state == INITIATED || this.state == FAILED) {
			...
			response = ntlm.getType3Message(ntcredentials.getUserName(), ntcredentials.getPassword(), ntcredentials.getHost(),
					ntcredentials.getDomain(), ntlm.parseType2Message(this.ntlmchallenge));
