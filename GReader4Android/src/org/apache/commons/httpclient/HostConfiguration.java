...
public class HostConfiguration implements Cloneable {
	 ...
	 */
	public synchronized void setHost(final String host, final String virtualHost, int port, final Protocol protocol) {
	...
	public synchronized boolean equals(final Object o) {
		if (o instanceof HostConfiguration) {
			...
			return LangUtils.equals(this.host, that.host) && LangUtils.equals(this.proxyHost, that.proxyHost)
