 ...
 * with {@link org.apache.commons.httpclient.HttpURL} rather than
 * {@link org.apache.commons.httpclient.URI}.
 * 
...
public class URIUtil {
	...
	/**
	 * Get the all escaped and encoded string with a given charset. It's the
	 * same function to use <code>encode(String unescaped, Bitset
	 ...
	 * an URI with the default protocol charset. Within the authority component,
	...
	/**
	 * Escape and encode a string regarded as within the authority component of
	 * an URI with a given charset. Within the authority component, the
	 ...
	 * URI with the default protocol charset. The path may consist of a sequence
	 * of path segments separated by a single slash "/" character. Within a path
	 * segment, the characters "/", ";", "=", and "?" are reserved.
	 * 
	 * @param unescaped
	 *            an unescaped string
	 * @return the escaped string
	...
	/**
	 * Escape and encode a string regarded as within the path component of an
	 * URI with a given charset. The path may consist of a sequence of path
	 * segments separated by a single slash "/" character. Within a path
	 * segment, the characters "/", ";", "=", and "?" are reserved.
	 * 
	 * @param unescaped
	 *            an unescaped string
	 ...
	 * URI with the default protocol charset. When a query comprise the name and
	 * value pairs, it is used in order to encode each name and value string.
	 * The reserved special characters within a query component are being
	 * included in encoding the query.
	 * 
	 * @param unescaped
	 *            an unescaped string
	 * @return the escaped string
	...
	/**
	 * Escape and encode a string regarded as within the query component of an
	 * URI with a given charset. When a query comprise the name and value pairs,
	 * it is used in order to encode each name and value string. The reserved
	 * special characters within a query component are being included in
	 * encoding the query.
	 * 
	 * @param unescaped
	 *            an unescaped string
	 ...
	 * the default protocol charset. When a query string is not misunderstood
	 * the reserved special characters ("&amp;", "=", "+", ",", and "$") within
	 * a query component, this method is recommended to use in encoding the
	 * whole query.
	 * 
	 * @param unescaped
	 *            an unescaped string
	...
	/**
	 * Escape and encode a string regarded as the query component of an URI with
	 * a given charset. When a query string is not misunderstood the reserved
	 * special characters ("&amp;", "=", "+", ",", and "$") within a query
	 * component, this method is recommended to use in encoding the whole query.
	 * 
	 * @param unescaped
	 *            an unescaped string
	 * @param charset
