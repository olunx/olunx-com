 ...
 * {@link java.lang.Object#hashCode() Object.hashCode()} should be overridden
 * appropriately. Protocol socket factories are used to uniquely identify
 * <code>Protocol</code>s and <code>HostConfiguration</code>s, and
 * <code>equals()</code> and <code>hashCode()</code> are required for the
 * correct operation of some connection managers.
 * </p>
 * 
 * @see Protocol
 * 
...
public interface ProtocolSocketFactory {
	 ...
	 * @since 3.0
	 */
	Socket createSocket(String host, int port, InetAddress localAddress, int localPort, HttpConnectionParams params) throws IOException,
