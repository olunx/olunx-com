...
public class Protocol {
	 ...
	 *             version of the constructor is only kept for backwards API
	 *             compatibility.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Protocol) {
			...
			return (defaultPort == p.getDefaultPort() && scheme.equalsIgnoreCase(p.getScheme()) && secure == p.isSecure() && socketFactory
					.equals(p.getSocketFactory()));
