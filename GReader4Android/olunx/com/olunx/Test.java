...
public class Test {
	...
	public static void main(String[] args) throws GoogleReaderException, AuthenticationException {
		...
		// GoogleReader googleReader = new GoogleReader("olunxs@gmail.com",
		// "646895472");
		// googleReader.login();
		...
		// List<FeedDescriptor> list =
		// GoogleReaderUtil.getFeedDescriptorsFromXml(dataProvider.getSubscriptions());
		//		
