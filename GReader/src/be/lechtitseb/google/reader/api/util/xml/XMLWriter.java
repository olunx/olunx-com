...
//	private static final Logger logger = Logger.getLogger(XMLWriter.class.getName());
	 ...
	 * @throws IOException
	 */
	public Document write(Document returnValue, File destinationFile) throws IOException {
		if (returnValue == null) {
		...
		try {
			...
			oStream = new OutputStreamWriter(new FileOutputStream(destinationFile), "UTF-8");
